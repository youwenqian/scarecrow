...
<head>
    ...
    <script type="text/javascript" src="/statics/admin/brandList.js"></script>
...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加品牌','../brand/toBrandAdd', 600, 400)"><i class="layui-icon"></i>添加</button>
