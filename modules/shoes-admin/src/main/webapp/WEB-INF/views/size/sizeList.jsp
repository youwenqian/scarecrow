...
<head>
    ...
    <script type="text/javascript" src="/statics/admin/sizeList.js"></script>
...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加颜色','../size/toSizeAdd', 600, 400)"><i class="layui-icon"></i>添加</button>
