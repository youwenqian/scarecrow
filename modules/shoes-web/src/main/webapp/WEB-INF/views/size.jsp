...
<table class="layui-hide" id="table" lay-filter="sizeTable"></table>
...
<form id="editForm" role="form" style="display:none">
    ...
    <div class="col-sm-4">
        <input type="text" class="form-control" id="nameEdit" name="sizeName" placeholder=“请输入名称”>
    </div>
...
<form id="addForm" role="form" style="display:none">
    ...
    <div class="col-sm-4">
        <input type="text" class="form-control" id="nameAdd" name="sizeName" placeholder=“请输入名称”>
    </div>
...
<script src="<%=basePath%>js/custom/manage-size.js"></script>
</body>
</html>
