...
function refreshPageList() {
	$("#div_load").load(basePath + "notification/notification-list",$("#searchNotificationForm").serialize());
}
...
function showNotificationDetail(notificationId) {
	$.get(basePath+'notification/notification-detail?notificationId=' + notificationId, function(data) {
		layer.open({
			type:1,
		    area:  ['700px', '800px'],
			title: '详情',
...
function notificationComplex(notificationId) {
	...
	$.ajax({
		type:"post",
		url:basePath + "notification/notification-complex",
